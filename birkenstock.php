...
<head>
    ...
    <title>TheFitsStore/Birkenstock</title>
...
<body >
    ...
    <nav>
    <img onclick="window.location.href='birkenstock.php'" style="height: 100px; width:100px ; border:oldlace; border-radius:50%;" src="images/logo.jpg" alt="">
        <div class="navigation">
            ...
            <i id="menu-close" class="fas fa-times"></i>
                ...
                <li><a  href="#" class="active">Birkenstock</a></li>
...
$result = $db->query("SELECT * FROM images_birkenstock ORDER BY id DESC"); 
?>
