...
<head>
    ...
    <title>TheFitsStore/Cloths</title>
...
<body>
    ...
    <nav>
    <img onclick="window.location.href='cloth.php'" style="height: 100px; width:100px ; border:oldlace; border-radius:50%;" src="images/logo.jpg" alt="">
        ...
        <ul>
                ...
                <li><a href="#" class="active">Cloths</a></li>
...
$result = $db->query("SELECT * FROM images_shirts ORDER BY id DESC"); 
?>
